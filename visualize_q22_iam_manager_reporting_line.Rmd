---
title: "The reporting lines of the IAM Manager"
output: html_notebook
---

# In a nutshell

This notebook uses an Euler chart to visualize the reporting lines of IAM managers.

# The data analysis

## Introduction

As part of the *IAM Performance Measurement 2020 Survey*, I surveyed IAM professionals about the reporting lines IAM managers in their organization.  

In this data analysis notebook, we will use R to analyse and visualize the answers to this question.
...
When the survey participant selected the **Other* option, he could type in the other function name. In this notebook, we will *not* analyse the answers provided in free text form.
...
Then we need to retrieve our data. 
